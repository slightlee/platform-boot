package com.demain.platform.core.aspect;
...
public class PreventDuplicationAspect {
     ...
     * 定义切点
     */
    @Pointcut("@annotation(com.demain.platform.core.annotation.PreventDuplication)")
    ...
    public Object before(ProceedingJoinPoint joinPoint) throws Exception {
        ...
        String redisKey = Constants.PREVENT_DUPLICATION_PREFIX
                .concat(token)
