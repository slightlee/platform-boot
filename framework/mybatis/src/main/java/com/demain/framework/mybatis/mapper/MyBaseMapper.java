...
/**
 * mapper 层 选装件 选装件位于 com.baomidou.mybatisplus.extension.injector.methods 包下 需要配合 Sql 注入器使用
 * {@link com.demain.framework.mybatis.injector.MyLogicSqlInjector}
 */
public interface MyBaseMapper<T> extends BaseMapper<T> {
     ...
     * 批量新增数据
     * <p>
     * 注：官方说明 批量新增数据,自选字段 insert
     * <p>
     * 不同的数据库支持度不一样!!! 只在 mysql 下测试过!!! 只在 mysql 下测试过!!! 只在 mysql 下测试过!!!
     * </p>
     * <p>
     * 除了主键是 <strong> 数据库自增的未测试 </strong> 外理论上都可以使用!!!
     * </p>
     * <p>
